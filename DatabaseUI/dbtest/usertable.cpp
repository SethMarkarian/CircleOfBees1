 ...
 * @return
 */
int UserTable::add_row(std::string email, std::string firstName, std::string lastName, std::string userName, std::string password) {
    ...
    std::cout << "retcCode: " << retCode << std::endl;
    return retCode;
}
